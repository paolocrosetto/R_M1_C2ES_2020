...
## existentes month , year,  compagnie
## à creer : nombre d'accidents par month /year/ compagnie
...
#etape 2 : creer le plot en version brut
## il faut que toutes le sdimensions soient au bon endroit

base %>% 
  ggplot(aes(x = incident_month, y = incident_year, 
             fill = n))+
  facet_wrap(~operator)+
...
plot_base +
  ...
  labs(title = "Airlines Bird Trikes",
       x = "Month",
       y = "Year")
...
#etape 1 : données (summarise, mutate...)

# etape 2 : graphique brut (ggplot, facet, ...)
