...
jg1%>%
  ...
  scale_color_viridis_d()+
  labs(title = "Emplois occupés à plus de 90 % par des Femmes américaines entre 2013-2016, tout âge confondus")+
  theme_grey()+
  xlab("year")+ 
...
jg2%>%
  ...
  facet_wrap(~occupation)+
  scale_color_viridis_d()+
  labs(title = "Emplois occupés à moins de 10 % par des Femmes américaines entre 2013-2016, tout âge confondus")+
  theme_grey()+
  xlab("year")+ 
  ylab("Percent of women for specific occupation")
