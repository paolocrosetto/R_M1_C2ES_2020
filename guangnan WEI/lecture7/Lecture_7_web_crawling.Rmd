...
- on veut le titre , l'année, et le nombred'étoiles par film(il y a en 250)
...
#2.pour chaque element chercher le mode et appliquer html_text
...
#étoile
etoile<- imdb %>% html_nodes(".imdbRating") %>% html_text()


#3.coller les vecteurs ensemble avec 'tibble()'
imdb_data<-tibble(title,data,etoile)
