...
## exercice 
Regréssion de Ozone sur Wind et Temp + plot des coefficients 
```{r}
...
Si on regarde l'objet obtenu on peut voir qu'on obtient un objet qui contient sur chaque ligne un coefficient de l'estimation par group -- ici année/continent. 
...
# 4. Faire le plot des intervals de confiance
...
est-ce que le gdp percapita est inférieur à 2000 euros / an par continent par année ? 
```{r}
# stratégie 
# 1. group by 
