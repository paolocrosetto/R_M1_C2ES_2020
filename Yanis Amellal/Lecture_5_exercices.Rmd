...
## étape 1 : pcrééer les variables d'intérêt 
...
## étape 2 : créer le plot en version brut 
...
```{r}
plot_base + coord_cartesian(ylim = c(2000, 2018))+ scale_fill_gradient(low = "white", 
                                                                       high = "#ee3d8e")
theme_minimal() + 
  theme(panel.background = element_rect(color = "grey95"), plot.background = element_rect(fill = "grey90"), plot.title = position "center") + 
